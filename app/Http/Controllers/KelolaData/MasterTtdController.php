    ...
    public function load(Request $request)
    {
        if ($request->ajax()) {
            ...
            ->addColumn('aksi', function ($row) {
                ...
                $btn = '<a href="' . route("kelola_data.master_ttd.edit", Crypt::encrypt($row->id)) . '" class="btn btn-md btn-warning" style="margin-right:4px"><span class="fa-fw select-all fas"></span></a>';
