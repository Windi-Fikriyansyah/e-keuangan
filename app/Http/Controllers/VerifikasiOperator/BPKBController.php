...
class BPKBController extends Controller
{
    ...
    {
        return view('verifikasi_operator.bpkb.index');
    }
    ...
    public function verifikasi(Request $request)
    {
        ...
        // CEK TELAH VERIFIKASI ADMIN
        if ($dataPeminjaman->statusVerifAdmin == '1') {
            return response()->json([
                'status' => true,
                'message' => 'Batal Verifikasi tidak dapat dilakukan, data telah diverifikasi oleh admin! Silahkan refresh!'
            ], 500);
        }
        ...
        try {
            ...
            if ($tipe === 'setuju') {
                $pinjamanBpkb->update([
                    ...
                    'tanggalVerifikasiOperator' => $tanggalVerifikasi,
                ]);
            } else {
                $pinjamanBpkb->update([
                    'statusVerifikasiOperator' => '0',
                    'userVerifikasiOperator' => '',
