...
@section('title', 'Verifikasi Operator Sertifikat')
@section('content')
    <div class="page-heading">
        <h3>Verifikasi Operator Sertifikat</h3>
    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" id="tanggalVerifikasiOperator" name="tanggalVerifikasiOperator" type="date">
                        </div>
                    </div>
                    <div class="row mb-3">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#sertifikat').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('verifikasi_operator.sertifikat.load') }}",
                    type: "POST",
                    data: function(data) {
        ...
        function verif(nomorSurat) {
            $.ajax({
                url: '{{ route("verifikasi_operator.sertifikat.verif") }}',
                type: 'POST',
                data: {
        ...
        $('#VerifOperator').on('click', function() {
            ...
            if (!tanggalVerifikasiOperator) {
                ...
                if (tanggalVerifikasiOperator < tanggalPinjam) {
                    Swal.fire({
                        title: "Peringatan!",
            ...
            $.ajax({
                url: '{{ route("verifikasi_operator.sertifikat.verifikasi_operator") }}',
                type: 'POST',
                data: {
                    nomorSurat: nomorSurat,
                    tanggalVerifikasiOperator: tanggalVerifikasiOperator,
                    _token: '{{ csrf_token() }}'
                },
        ...
        $('#BatalkanVerif').on('click', function() {
            ...
            $.ajax({
                url: '{{ route("verifikasi_operator.sertifikat.batalkan") }}',
                type: 'POST',
                data: {
                    nomorSurat: nomorSurat,
                    _token: '{{ csrf_token() }}'
