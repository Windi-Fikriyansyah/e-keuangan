                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="form-control readonlyInput" id="statusTolak" name="statusTolak"
                                    type="text" hidden>
                                <input class="form-control readonlyInput" id="statusVerifikasiOperator"
                                    name="statusVerifikasiOperator" type="text" hidden>
                            </div>
                        </div>
                        <div class="row mb-3">
...
@push('js')
    ...
    <script>
        ...
        function pengajuan(nomorSurat, nomorRegister, kodeSkpd, file, statusPengajuan, statusTolak,
            statusVerifikasiOperator) {
