    ...
    <script>
        $(document).ready(function() {
            ...
            $('#sertifikat').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('verifikasi_bast.sertifikat.load') }}",
                    type: "POST",
                    data: function(data) {
        ...
        function verif(nomorSurat) {
            $.ajax({
                url: '{{ route("verifikasi_bast.sertifikat.verif") }}',
                type: 'POST',
                data: {
        ...
        $('#VerifBast').on('click', function() {
            ...
            $.ajax({
                url: '{{ route("verifikasi_bast.sertifikat.verifikasi_bast") }}',
                type: 'POST',
                data: {
                    nomorSurat: nomorSurat,
                    _token: '{{ csrf_token() }}'
        ...
        $('#BatalkanVerif').on('click', function() {
            ...
            $.ajax({
                url: '{{ route("verifikasi_bast.sertifikat.batalkan") }}',
                type: 'POST',
                data: {
                    nomorSurat: nomorSurat,
                    _token: '{{ csrf_token() }}'
