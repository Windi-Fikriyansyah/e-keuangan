        ...
        <div class="card radius-10">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <h5 class="card-title mb-0">Data Ms Anggaran</h5>
                    <div class="d-flex gap-2">
                        <!-- Tombol untuk membuka modal -->
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#uploadModal">
                            Upload Excel
                        </button>
                        <a href="{{ route('kelola_data.msanggaran.download_format') }}" class="btn btn-info">Format Excel</a>
                        <a href="{{ route('kelola_data.msanggaran.create') }}" class="btn btn-success">Tambah</a>
                    </div>
                </div>
            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#pajak').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('kelola_data.msanggaran.load') }}",
                    type: "POST"
                },
                pageLength: 10,
                searching: true,
                columns: [
                    ...
                    { data: 'kd_rek', name: 'kd_rek' },
                    { data: 'nm_rek', name: 'nm_rek' },
            ...
            $('#uploadForm').submit(function(e) {
                ...
                $.ajax({
                    url: "{{ route('kelola_data.msanggaran.upload') }}",
                    type: "POST",
                    data: formData,
                    processData: false,
                    contentType: false,
