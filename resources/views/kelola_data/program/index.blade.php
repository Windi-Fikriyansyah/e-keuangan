            ...
            <div class="card-header">
                <div class="d-flex align-items-center">
                    ...
                    <div class="dropdown ms-auto">
                        <a href="{{ route('kelola_data.program.create') }}" class="btn btn-success">Tambah</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#pajak').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('kelola_data.program.load') }}",
                    type: "POST"
                },
                pageLength: 10,
                searching: true,
                columns: [
                    ...
                    { data: 'kd_program', name: 'kd_program' },
                    { data: 'nm_program', name: 'nm_program' },
