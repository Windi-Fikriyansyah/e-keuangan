            ...
            <div class="card-body">
                <form method="POST" action="{{ route('strpot.store') }}" id="formBpkb">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-4">
                            <input name="no_sp2d" id="no_sp2d" class="form-control" type="text" readonly>
                         </div>
                        <label class="col-sm-2 col-form-label">Pembayaran</label>
                        <div class="col-sm-4">
                            <input name="pay" id="pay" class="form-control" type="text" readonly>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-4">
                            <input name="kd_sub_kegiatan" id="kd_sub_kegiatan" class="form-control" type="text" readonly>
                         </div>
                        <label class="col-sm-2 col-form-label">Nama Kegiatan</label>
                        <div class="col-sm-4">
                            <input name="nm_sub_kegiatan" id="nm_sub_kegiatan" class="form-control" type="text" readonly>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-4">
                            <input name="kd_rek6" id="kd_rekening" class="form-control" type="text" readonly>
                         </div>
                        <label class="col-sm-2 col-form-label">Nama Rekening</label>
                        <div class="col-sm-4">
                            <input name="nm_rek6" id="nm_rekening" class="form-control" type="text" readonly>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-4">
                            <input name="nmrekan" id="nmrekan" class="form-control" type="text" readonly>
                         </div>
                        <label class="col-sm-2 col-form-label">Pimpinan</label>
                        <div class="col-sm-4">
                            <input name="pimpinan" id="pimpinan" class="form-control" type="text" readonly>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-4">
                            <input name="beban" id="beban" class="form-control" type="text" readonly>
                         </div>
                        <label class="col-sm-2 col-form-label">NPWP</label>
                        <div class="col-sm-4">
                            <input name="npwp" id="npwp" class="form-control" type="text" readonly>
                        </div>
                    </div>
                    <input name="id_trhtransout" id="id_trhtransout" class="form-control" type="hidden" readonly>
