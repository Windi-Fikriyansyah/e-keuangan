            ...
            <div class="card-body">
                <form method="POST"action="{{ route('transaksi.store') }}" id="formBpkb">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-4">
                            <input id="tgl_bukti" class="form-control @error('tgl_bukti') is-invalid @enderror"
                                type="date" placeholder="Tidak perlu diisi, otomatis" name="tgl_bukti" disabled
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-4">
                            <input id="jenis_beban" class="form-control @error('jenis_beban') is-invalid @enderror"
                                type="text" placeholder="Tidak perlu diisi, otomatis" name="jenis_beban" disabled
                                value="{{ $transaksi->jenis_beban }}">
                            @error('jenis_beban')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control @error('ket') is-invalid @enderror" type="text" name="ket" placeholder="Keterangan"
                                disabled>{{ old('ket', $transaksi->ket) }}</textarea>
                            @error('ket')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
        ...
        $(document).ready(function() {
            function hitungTotalBelanja() {
                ...
                $("#pajak tbody tr").each(function() {
                    let nilai = $(this).find("td:eq(4)").text().replace(/\./g, "")
                        .trim(); // Ambil nilai dan hilangkan format ribuan
