...
<head>
    ...
    <title>Cetak Laporan Register Sp2d</title>
    <style>
            ...
            <tbody>
                ...
                @forelse($trhtransout as $index => $data)
                    <tr>
                        ...
                        <td>{{ isset($data->tgl_bukti) ? \Carbon\Carbon::parse($data->tgl_bukti)->format('d-m-Y') : '' }}
                        </td>
                        <td>{{ $data->no_sp2d }}</td>
                        <td>{{ $data->ket }}</td>
                        {{-- <td>
                ...
                <tr>
                    <td colspan="4" class="text-right">Jumlah sampai Periode Ini</td>
