        ...
        <div class="card radius-10">
            <div class="card-header">
                <div class="d-flex align-items-center">
                    <div>
                        <h5 class="card-title">LPJ TU</h5>
                    </div>
                    <div class="dropdown ms-auto">
                        <a href="{{ route('lpj_tu.create') }}" class="btn btn-success">Tambah</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="printModalLabel">Cetak LPJ TU</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="printForm" action="{{ route('lpj_tu.print') }}" method="POST" target="_blank">
                    @csrf
                    <div class="mb-3">
...
<script>
    ...
    $('#ttdpaka').select2({
        ...
        placeholder: "Silahkan Pilih...",
        ajax: {
            url: "{{ route('lpj_tu.tandaTanganPa') }}",
            dataType: 'json',
            type: "POST",
            data: function(params) {
                return {
